...
const SignIn: React.FC = () => {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    if (res && res.ok) {
      ...
      if (res?.status === 403 || res?.error?.slice(-3) === "403")
        toast.error(
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="mb-5">
              <Button
                ...
                size={"lg"}
                disabled={loading}
                className="focus:shadow-outline m-2 h-12 w-full rounded-lg bg-indigo-700 px-5 text-lg text-indigo-100 transition-colors duration-150 hover:bg-indigo-800"
              >
                Sign In
              </Button>
            </div>
